...
class CountryParentAdapter(
    ...
    private val listener: CountryAndRegionsListenerInterface
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.countryName.text = content.keys.elementAt(position)

        val size = content[holder.countryName.text]?.size
...
class RegionChildAdapter(
    ...
    private val selectCheckBoxInterface: CountryAndRegionsListenerInterface
