...
class TagsFilterParentAdapter(
    private val parentList: Map<String, List<ElementTagModel>>,
    private val selectCheckBoxInterface: SelectCheckBoxInterface
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tagTitle.text = StringUtil.formatTagString(parentList.keys.elementAt(position))
        ...
        holder.imageView.setImageDrawable(
            ContextCompat.getDrawable(
                ...
                if (isExpanded) R.drawable.expand_less_icon else R.drawable.expand_more_icon
            )
        )
...
class TagsFilterChildAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.checkBox.apply {
            ...
            text = StringUtil.formatTagString(child.tagName)
            tag = child.tagName
