...
object PoiTagsUtil {
    ...
    fun extractCategoryFromPoiEntity(tagsMap: Map<String, String>): String? {
        return when {
            ...
            tagsMap.containsKey("station") -> tagsMap["station"]
            ...
            tagsMap.containsKey("sport") -> "sport"
    ...
    fun getPoiType(map: Map<String, String>): String? {
        return when {
            map.containsKey("vending") -> map["vending"]
            map.containsKey("sport") -> map["sport"]
            else -> null
        }
    }
    ...
    fun extractCategoryFromPoiEntity(tagsMap: Map<String, String>): String? {
        return when {
            ...
            tagsMap.containsKey("shop") -> "shop"
            tagsMap.containsKey("sport") -> "sport"
            tagsMap.containsKey("leisure") -> "leisure"
            tagsMap.containsKey("tourism") -> "tourism"
            tagsMap.containsKey("seamark:type") -> tagsMap["seamark:type"]
            else -> null
        }
    }*/
